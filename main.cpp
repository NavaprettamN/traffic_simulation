...
int i2;
    ...
    {
        xt[i2]=pow(1-t,3)*x[0]+3*t*pow(1-t,2)*x[1]+3*pow(t,2)*(1-t)*x[2]+pow(t,3)*x[3];
        y1t[i2]=pow(1-t,3)*Y1[0]+3*t*pow(1-t,2)*Y1[1]+3*pow(t,2)*(1-t)*Y1[2]+pow(t,3)*Y1[3];
        y2t[i2]=pow(1-t,3)*Y2[0]+3*t*pow(1-t,2)*Y2[1]+3*pow(t,2)*(1-t)*Y2[2]+pow(t,3)*Y2[3];
        y3t[i2]=pow(1-t,3)*Y3[0]+3*t*pow(1-t,2)*Y3[1]+3*pow(t,2)*(1-t)*Y3[2]+pow(t,3)*Y3[3];
        i2++;
    }
    glColor3f(1,1,0);
    ...
    for(i2=0;i2<200;i2++)
    {
        glVertex2d(xt[i2],y1t[i2]);
        glVertex2d(xt[i2],y2t[i2]);
    }
    glEnd();
    ...
    {
        glVertex2d(xt[i2],y2t[i2]);
        glVertex2d(xt[i2],y3t[i2]);
    }
    glEnd();

   glColor3f(0.5,0.5,0.5);
  glRectf(85,460,100,150);
	//glFlush();
//
//
//
...
int c_menu;
    printf("\n");
    printf(" |===========================================================|\n");
    printf(" |==> WelCome to our project about Traffic Control System <==|\n");
    printf(" |-----------------------------------------------------------|\n");
    printf(" #----   A project by :-                                     |\n");
    printf(" #----                  NAVAPRETTAM N [4GM20CS065]           |\n");
    printf(" #----                  OM G DALBANJAN [4GM20CS067]          |\n");
	printf(" |-----------------------------------------------------------|\n");
    printf(" |                                                           |\n");
